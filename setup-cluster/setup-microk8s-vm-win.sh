...
multipass exec microk8s-vm -- wget https://github.com/kubernetes-sigs/cri-tools/releases/download/v1.24.1/crictl-v1.24.1-linux-amd64.tar.gz
multipass exec microk8s-vm -- sudo tar zxvf crictl-v1.24.1-linux-amd64.tar.gz -C //usr/local/bin
multipass exec microk8s-vm -- rm -f crictl-v1.24.1-linux-amd64.tar.gz
